                ...
                children: [
                  Text(
                    ...
                    style: GoogleFonts.lexend(
                      ...
                      letterSpacing: 2,
                      shadows: [
                        Shadow(color: rarityColor.withOpacity(0.5), blurRadius: 10),
                      ],
                    ),
                  ),
      ...
      builder: (ctx) {
        return Consumer(
          builder: (context, ref, _) {
            ...
            // Find the latest version of this item
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      item.name,
                      style: GoogleFonts.outfit(
                        color: item.category == 'title' ? getRarityColor(item.rarity) : Colors.white,
                        fontSize: 22,
                        fontWeight: FontWeight.w800,
                        letterSpacing: 0.5,
                        shadows: item.category == 'title' ? [
                          Shadow(color: getRarityColor(item.rarity).withOpacity(0.5), blurRadius: 10)
                        ] : null,
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            elevation: isEquipped ? 0 : 4,
                            padding: EdgeInsets.zero,
                          ).copyWith(
                            backgroundColor: isEquipped
                                ? WidgetStateProperty.all(color.withOpacity(0.15))
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Text(
                                    isEquipped ? "CURRENTLY EQUIPPED" : "EQUIP ITEM",
                                    style: GoogleFonts.outfit(
                                      color: isEquipped ? color : Colors.white,
                                      fontSize: 14,
                                      fontWeight: FontWeight.w800,
