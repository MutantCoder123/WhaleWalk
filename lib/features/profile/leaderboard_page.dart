...
class _LeaderboardPageState extends ConsumerState<LeaderboardPage>
  ...
  Widget _buildLeaderboardTab({
    ...
    if (entries.isEmpty) return Center(child: Text("No rankings yet", style: TextStyle(color: mutedColor)));
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return _buildRankRow(rank, entry['username'] ?? 'Unknown', title, value, valueSuffix, valueIcon, valueColor, surfaceColor, textColor, mutedColor);
              },
  ...
  Widget _buildPodium(int rank, Map<String, dynamic> entry, Color color, double height, bool isDark, Color textColor, String valueKey, String valueSuffix, Color valueColor) {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text("$value$valueSuffix", style: TextStyle(fontSize: 10, color: valueColor, fontWeight: FontWeight.bold)),
            ],
          ),
        ),
      ],
  ...
  Widget _buildRankRow(int rank, String name, String title, dynamic value, String valueSuffix, IconData valueIcon, Color valueColor, Color surface, Color text, Color muted) {
    return Container(
      ...
      child: Row(
        children: [
          SizedBox(width: 40, child: Text("#$rank", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: muted))),
          CircleAvatar(backgroundColor: Colors.blue.withOpacity(0.1), child: Icon(Icons.person, color: Colors.blue.shade300)),
